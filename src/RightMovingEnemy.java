...
public class RightMovingEnemy extends Enemy {
    private BulletTimer bulletDelayTimer;
    private double startXCoor, startYCoor;
    private int time = 0;

    public RightMovingEnemy(double width, double height, long bulletDelay, double dx, double dy, double xCoor, double yCoor) {
